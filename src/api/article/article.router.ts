...
import { CreateArticleRequest, GetRecentArticlesRequest, GetArticleByIdRequest } from "../../types/dto/article.dto";
...
articleRouter.get("/recent", validateQuery(GetRecentArticlesRequest), articleController.getRecentArticles);
articleRouter.get("/recent/:username", validateQuery(GetRecentArticlesRequest), articleController.getRecentArticlesByUsername);
